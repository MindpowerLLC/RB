...
contract RudeBirdsOfficial is ERC721Enumerable, Ownable { // contract name to yours
  using Strings for uint256;

  string public baseURI;
  string public baseExtension = ".json";
  uint256 public cost = .035 ether; // change price per unit
  ...
  uint256 public maxMintAmount = 400; // max allowed to mint at one time N.O.T.E must be => than line 1241 - mint(msg.sender, 10);
  ...
  constructor(
    ...
    mint(msg.sender, 210); // Must be lower than line 1231 | This is how many is minted FREE to owner upon deployment
  }
